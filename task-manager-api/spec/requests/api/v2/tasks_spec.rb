...
RSpec.describe 'Task API' do
  before { host! 'api.taskmanager.com' }
  ...
  describe 'GET /tasks' do
    ...
    context 'when no filter param is sent' do
      ...
      it 'returns 5 taks from database' do
    ...
    context 'when filter params is sent' do
      ...
      it 'retuns only the tasks matching' do
  ...
  describe 'POST /tasks' do
    ...
    context 'when the params are valid' do
      ...
      it 'returns the josn for created task' do
        expect(json_body[:data][:attributes][:title]).to eql(task_params[:title])
      end

      it 'asssigns the created task to the current user' do
  ...
  describe 'DELETE /tasks/:id' do
    ...
    it 'removes the tsk from the database' do
